...
//		Kali.CampaCola cc =new Kali().new CampaCola(); (without thief while CampaCola not private)
...
class Kali2 {
	public void sellCola() {
		...
		// merging...1
		// merging 1 problem - The class called campacola ia still existing...
		
		// new Thief would know i have camapacola and try to steal
		// so we desolve campacola within our company
...
//		CampaCola cc = new CampaCola(); (campacola company doesn't exist anymore)
//		cc.makeCola();
		...
		// Strategy 3 - Lambda
		Cola2 ccc=()-> {
			System.out.println("Cola made by campa cola ... using lambda");
		};
		ccc.makeCola();
		
		System.out.println("kali fills campa cola in bovonto to bottle and sell..");
	}
...
//	}
	...
	// by puting this class inside Kali we have gone from association to aggregation
